    ...
    public partial class General1 : Form
    {
       ...
       /* private void ingresos1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        ...
        private void show(DataGridView d, DataGridViewCellEventArgs e)
        {
            ...
            switch (areaName)
            {
                case "Area": showArea(new Area(),e); break;
                case "Area2": showArea2(new Area2()); break;
                case "Area3": showArea3(new Area3()); break;
                case "Area4": showArea4(new Area4()); break;

            }
          
        }

        private void showArea(Area area, DataGridViewCellEventArgs e)
        {          
            area.con = con;
            area.general1 = this;
        ...
        */
        private void ingresos1_CellContentClick_1(object sender, DataGridViewCellEventArgs e)
        {
            Area area = new Area();
            area.con = con;
            area.general1 = this;
