...
{
    public partial class General4 : Form
    {
        public Conexion con;
        ...
        private void General4_Load(object sender, EventArgs e)
        {
        ...
        private void areasIngresos1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            Area area = new Area();
            area.con = con;
            area.general4 = this;
